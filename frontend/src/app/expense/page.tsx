...
import { Cell, Legend,Tooltip, ResponsiveContainer , PieChart, Pie} from "recharts";
...
const Expenses=()=>{
  ...
  const [selectedCategory,setSelectdCategory]=useState("Todos")
  ...
  const classNames ={
    ...
    selectedInput:"mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:ring-indigo-500 facus:border-indigo-500 sm:text-sm rounded-md"
  };
  if (isLoading){
  ...
  return (
   <div className="mb-5">
    ...
    <p className="text-sm text-gray-500">
      ...
      <div className="flex flex-col mf:flex-row justify-between gap-4">
        <div className="w-full md:w-1/3 bg-white shadow rounded-lg p-6">
          ...
          <div className="space-y-4">
            <div className="flex gap-4">
              ...
              className={classNames.label}>Categoria
